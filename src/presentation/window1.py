...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.CameraLabel.setGeometry(QRect(10, 10, 471, 431))
        ...
        self.Window2Button = QPushButton(self.centralwidget)
        self.Window2Button.setObjectName(u"Window2Button")
        self.Window2Button.setGeometry(QRect(10, 450, 481, 91))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Window2Button.setText(QCoreApplication.translate("MainWindow", u"Window2", None))
